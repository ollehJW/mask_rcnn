...
if __name__ == "__main__":
    ...
    labelme_json = glob.glob(os.path.join('./data/train', "*.json"))
    labelme2coco(labelme_json, './data/train.json')
    labelme_json = glob.glob(os.path.join('./data/test', "*.json"))
    labelme2coco(labelme_json, './data/test.json')